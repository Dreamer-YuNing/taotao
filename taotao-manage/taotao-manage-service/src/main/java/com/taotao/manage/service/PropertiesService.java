...
public class PropertiesService {
    ...
    //redis缓存中所有内容详情ItemDesc的key
    @Value("${REDIS_ITEM_DESC_KEY}")
    public String REDIS_ITEM_DESC_KEY;

    //redis缓存中内容详情ItemDesc的生存时间
    @Value("${REDIS_ITEM_DESC_AKK_TIME}")
    public Integer REDIS_ITEM_DESC_AKK_TIME;
}
