...
function getparam() {
    for (var a = "", b = "", c = (new Object, location.search.substring(1)), d = c.split("&"),
             e = 0; e < d.length; e++) {
        var f = d[e].indexOf("=");
        if (-1 != f) {
            {
...
!function () {
    ...
    var parse = function (a, b, c) {
        a = cleanWhiteSpace(a);
        for (var d = ["var TrimPath_Template_TEMP = function(_OUT, _CONTEXT, _FLAGS) { with (_CONTEXT) {"],
                 e = {stack: [], line: 1}, f = -1; f + 1 < a.length;) {
            var g = f;
